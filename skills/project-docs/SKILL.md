---
name: project-docs
description: Analyze the latest codebase and update all project documentation (.md, .sql) under docs/. Validates folder structure, naming conventions, quality, and keeps docs in sync with code. Supports multiple languages.
